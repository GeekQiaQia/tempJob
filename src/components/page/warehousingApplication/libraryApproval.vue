<template>
  <div class="libraryApproval">
    <div class="top_">
      <p><span>业务单号：111111111</span> <i>待审核</i><em>先打</em></p>
    </div>
    ...
    <ul class="option clearfix">
      ...
      <li>
        ...
        <p v-else>
          ...
          <el-input placeholder="详细原因" class="input382" v-model="input382"></el-input>
        </p>
      </li>
    </ul>
    <div class="newBtn">
...
<script>
import { getBussinessDetail } from "@/api/api";
export default {
  name: "libraryApproval",
  data() {
    return {
      input: "",
      input1: "",
...
.libraryApproval .top_{
  padding-top:22px;
  height: 64px;
}
.libraryApproval .top_ span{
  font-size: 18px;
   font-weight:600;
   margin-right: 16px;
}
.libraryApproval .top_ i{
    width:52px;
    height:20px;
    background:rgba(83,118,255,1) linear-gradient(127deg,rgba(119,133,255,1) 0%,rgba(97,124,255,1) 100%);
    border-radius:2px;
    margin-right: 5px;
}
.top_ i,em {
...
.libraryApproval .top_ em{
    width:40px;
    height:20px;
    background:linear-gradient(303deg,rgba(42,133,255,1) 0%,rgba(0,226,220,1) 100%);
    border-radius:2px;
}
.libraryApproval header > ul{
  margin-bottom: 24px;
  margin-right: 24px;
}
.libraryApproval header > ul:nth-child(1) ,.libraryApproval header > ul:nth-child(3){
  width: 255px;
  /* height: 176px; */
  border-radius: 4px;
  border: 1px solid rgba(236, 239, 245, 1);
}
.libraryApproval header > ul:nth-child(3){
  margin-right: 0px;
}
.libraryApproval header > ul:nth-child(2) {
  /* margin-left: 280px; */
  /* height: 176px; */
  width:612px;
  border-radius: 4px;
...
.libraryApproval header > ul:nth-child(2) li > div:nth-child(1) {
  width: 356px;
}
.libraryApproval header ul > li {
  padding-left: 16px;
  line-height: 58px;
  height: 58px;
}
.libraryApproval header ul > li > span {
  margin-right: 10px;
}
.libraryApproval .infoHead {
  border-bottom: 2px solid #e6e9f0;
}
.libraryApproval .infoHead div {
  padding-bottom: 8px;
}
.libraryApproval .infoHead .fl {
  padding-left: 12px;
  position: relative;
  color: #5376ff;
}
.libraryApproval .infoHead .fl i {
  position: absolute;
  left: 0;
  bottom: -2px;
  width: 80px;
...
.libraryApproval .info {
  margin-bottom: 25px;
}
.libraryApproval .section {
  margin-bottom: 24px;
}
.libraryApproval .section .headClass {
  color: #a3adc8;
}
.libraryApproval .section .addRow {
  margin-top: 25px;
  color: #5376ff;
}
.libraryApproval .section .addRow i {
  margin-right: 8px;
}
.libraryApproval .section .total {
  margin-top: 27px;
}
.libraryApproval .section .total .top {
  margin-bottom: 16px;
  color: #596689;
}
.libraryApproval .section .total .top i{
  margin-right: 6px;
}
.libraryApproval .section .total li {
...
.libraryApproval .section .total li .txt {
  line-height: 26px;
  font-size: 12px;
  color: rgba(163, 173, 200, 1);
}
.libraryApproval .section .total li .num {
  line-height: 26px;
  font-size: 18px;
  font-weight: 500;
  color: rgba(50, 62, 97, 1);
}
.libraryApproval .section .headerClass {
  color: #a3adc8;
}
.newBtn {
  margin-top: 40px;
