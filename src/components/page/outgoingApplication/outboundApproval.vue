<template>
  <div class="outboundApproval">
    ...
    <ul class="option clearfix">
      ...
      <li class="fl" v-else-if="(flowType==30004  && outBoundDatas.auditStatus ==50002 && jobType==1101 || flowType==30001  && outBoundDatas.auditStatus ==50002 && jobType==1101)">
        <div>审批意见</div>
        <p>
       ...
       <!-- <li class="fl" v-else style="background:#fff">
        ...
        <div style="padding-top:2px">
          <img src="../../../assets/img/status.png" alt="" style="vertical-align:middle;margin-right:8px"><span style="display:inline-block">等待审批中</span>
        </div>
      </li> -->
    </ul>
     <div class="newBtn" v-if="(flowType==30001 && jobType==1101 || status==1 && outBoundDatas.auditStatus==50002 && jobType==1101 || status==2 && outBoundDatas.auditStatus==50002 && jobType==1101) && !edit">
      <el-button @click="handle">确认</el-button>
      <el-button @click="handleBack">取消</el-button>
    </div>
    <div class="newBtn" v-else-if="(flowType==30004 && status==1 && jobType !=1101) || (flowType==30004 && status==1 && outBoundDatas.auditStatus-datas.auditStatus>0)">
